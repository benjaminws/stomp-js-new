...
/**
 * Do not acknowledge received message
 * @param {String} message id to inform server the message was not acknowledge
 */
Stomp.prototype.nack = function(message_id) {
  this.send_command('NACK', {'message-id': message_id});
};
/**
 * Begin transaction
